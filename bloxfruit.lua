...
local webhookUrl = "https://discord.com/api/webhooks/1383772347558789211/8UZlJQI-OQH_UQejtrWPHKse5qrOgHUK2SkFADuGQe_k2lBH-PVFTsQrB-ra8bZK1P2r"
...
ImageButton.Image = "rbxassetid://17221942833"
...
local MiscFarm = Tabs.Main:AddSection("Farm")
...
local boss = Tabs.Main:AddSection("Farm Boss")
    ...
    local Material = Tabs.Main:AddSection("Farm Material")
...
Tabs.Sea:AddParagraph({
      ...
      local ToggleEspKitsune = Tabs.Sea:AddToggle("ToggleEspKitsune", {Title = "Esp island kisune",Description = "", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Sea:AddToggle("ToggleTPKitsune", {Title = "Tp Island Kisune",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Sea:AddToggle("ToggleSailBoat", {Title = "Buy Ship",Description = "", Default = false })
    ...
    local ToggleTerrorshark = Tabs.Sea:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Sea:AddToggle("TogglePiranha", {Title = " Kill Piranha",Description = "", Default = false })
     ...
     local ToggleShark = Tabs.Sea:AddToggle("ToggleShark", {Title = "Kill Shark",Description = "", Default = false })
    ...
    local ToggleFishCrew = Tabs.Sea:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Sea:AddToggle("ToggleShip", {Title = "Ship Pirates",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Sea:AddToggle("ToggleGhostShip", {Title = "Ship ghost",Description = "",Default = false })
...
spawn(function()
    ...
    local AutoElite = Tabs.Main:AddSection("Farm Elite")

    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Attack elite",Description = "", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Treo + Đánh Thủy Mob",Description = "", Default = false })
...
local ToggleAutoW = Tabs.Main:AddToggle("ToggleAutoW", {Title = "Auto Nhấn W",Description = "", Default = false })
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    local AutoMysticIsland = Tabs.Main:AddSection("island  Bí Ẩn")


    Tabs.Main:AddButton({
        Title = "fly Đến island  Bí Ẩn",
        Description = "",
        Callback = function()
            TweenMirage()
        end
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Tween Gear",Description = "", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Auto Lock Moon + On race",Description = "", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Farm Hallow Sycthe",Description = "", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Yama",Description = "", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Tushita",Description = "", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Auto holy Tushita",Description = "", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Factory",Description = "", Default = false })
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Kill Katakuri V2",Description = "", Default = false })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "Awakening V2",Description = "",Default = false })
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Tp Player", Description = "",Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Spectate",Description = "", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Auto Lock Skill",Description = "", Default = false })
...
local Mastery = Tabs.Player:AddSection("Different")


local ToggleNoClip = Tabs.Player:AddToggle("ToggleNoClip", {Title = "Noclip",Description = "", Default = false })
...
local ToggleWalkonWater = Tabs.Player:AddToggle("ToggleWalkonWater", {Title = "Walk Water",Description = "", Default = true })
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "Run",Description = "", Default = true })
...
local ToggleEnablePvp = Tabs.Player:AddToggle("ToggleEnablePvp", {Title = "Auto On PVP", Description = "",Default = false })
...
local Teleport = Tabs.Teleport:AddSection("Tp Word")
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Buy Fruit",Description = "", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Find Fruit",Description = "", Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Join Raid",Description = "", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Kill Mob",Description = "", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Qua island ",Description = "", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Awakening V2",Description = "", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get Fruit under 1m",Description = "", Default = false })
...
local Toggle = Tabs.Visual:AddToggle("MyToggle", {Title = "Rainbow haki", Default = false })
...
local Toggle = Tabs.Visual:AddToggle("MyToggle", {Title = "Rainbow yoru", Default = false })
...
Tabs.Visual:AddButton({
	...
	Description = "",
	Callback = function()
        require(game:GetService("ReplicatedStorage").Notification).new(""):Display();
 wait()
 setthreadcontext(5)
...
local Fake = Tabs.Visual:AddSection("Fake Status")
...
local LockMoonToggle = Tabs.Race:AddToggle("LockMoon_Toggle", {Title = "lock moon", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Human and ghoul ",Description = "", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Farm + On Race",Description = "", Default = false })
...
local Mastery = Tabs.Shop:AddSection("Reset")
...
local Mastery = Tabs.Misc:AddSection("Different")
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://17221942833"
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "BypassTP",Description = "", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Clear Dame attack Mob",Description = "", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Off notify",Description = "", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "Screen white (fix lag)",Description = "", Default = false })
...
local Pos = Tabs.Setting:AddSection("Pos")
...
if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" and game.PlaceId == 7449423635 then
    WebhookurlFM = "https://discord.com/api/webhooks/1383772347558789211/8UZlJQI-OQH_UQejtrWPHKse5qrOgHUK2SkFADuGQe_k2lBH-PVFTsQrB-ra8bZK1P2r"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
    Webhookdao = "https://discord.com/api/webhooks/1383772347558789211/8UZlJQI-OQH_UQejtrWPHKse5qrOgHUK2SkFADuGQe_k2lBH-PVFTsQrB-ra8bZK1P2r"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or  game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
    WebhookElite = "https://discord.com/api/webhooks/1383772347558789211/8UZlJQI-OQH_UQejtrWPHKse5qrOgHUK2SkFADuGQe_k2lBH-PVFTsQrB-ra8bZK1P2r"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("ReplicatedStorage"):FindFirstChild("Cursed Captain") then
    WebhookBoss = "https://discord.com/api/webhooks/1383772347558789211/8UZlJQI-OQH_UQejtrWPHKse5qrOgHUK2SkFADuGQe_k2lBH-PVFTsQrB-ra8bZK1P2r"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
